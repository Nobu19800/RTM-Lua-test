...
local measure_luajittest_spec = {["implementation_id"]="measure_luajitTest", 
		 ["type_name"[="measure_luajitTest", 
...
-- @class measure_luajitTest
-- @brief measurement of the processing time
--
-- 処理時間計測用RTC
local measure_luajitTest = {}
measure_luajitTest.new = function(manager)
	local obj = {}
...
local MyModuleInit = function(manager)
    measure_luajitTest.Init(manager)

    -- Create a component
    local comp = manager:createComponent("measure_luajitTest")
end
